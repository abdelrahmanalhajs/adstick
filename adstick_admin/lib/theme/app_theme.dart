...
class AppTheme {
  ...
  static ThemeData adminTheme() => ThemeData(
    ...
    navigationBarTheme: NavigationBarThemeData(
      backgroundColor: dark2, indicatorColor: const Color.fromRGBO(255, 107, 43, 0.2),
      iconTheme: WidgetStateProperty.resolveWith((s) =>
          IconThemeData(color: s.contains(WidgetState.selected) ? brand : textMuted)),
      labelTextStyle: WidgetStateProperty.resolveWith((s) =>
          TextStyle(color: s.contains(WidgetState.selected) ? brand : textMuted, fontSize: 10, fontWeight: FontWeight.w600)),
    ),
    ...
    appBarTheme: const AppBarTheme(backgroundColor: dark2, elevation: 0, centerTitle: false,
        titleTextStyle: TextStyle(fontSize: 17, fontWeight: FontWeight.w800, color: Colors.white)),
